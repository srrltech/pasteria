...
common = {
    get_username = function() return "testuser" end,
    get_timestamp = function() return 123456 end,
    is_button_down = function() return false end,
    reload_script = function() end,
    unload_script = function() end,
    get_date = function() return "date" end,
    get_active_scripts = function() return {"hysteria"} end,
}
...
function vector_mt:__add(other)
    if type(other) == "number" then return vector(self.x + other, self.y + other, self.z + other) end
...
function vector_mt:to() return vector(0,0,0) end
function vector_mt:scaled() return vector(0,0,0) end
function vector_mt:angles() return vector(0,0,0) end
function vector_mt:dist() return 0 end
function vector_mt:dist_to_ray() return 0 end
function vector_mt:length() return 0 end
function vector_mt:to_screen() return vector(0,0,0) end
...
function color_mt:alpha_modulate() return self end
function color_mt:to_hex() return "000000" end
function color_mt:as_hsv() return self end
function color_mt:to_hsv() return 0,0,0 end
function color_mt:lerp() return self end
function color_mt:clone() return color(self.r, self.g, self.b, self.a) end
color = function(r, g, b, a)
    local c = {r=r or 255, g=g or 255, b=b or 255, a=a or 255}
...
require = function(mod)
    if mod == "table.new" then return function() return {} end end
    if mod == "table.clear" then return function(t) for k in pairs(t) do t[k] = nil end end end
    ...
    local function create_dummy()
        ...
        setmetatable(t, {
            __index = function(self, k)
                ...
                if k == "alpha" then return 1 end
                if k == "macros" then return {} end
                local nt = create_dummy()
                rawset(self, k, nt)
                return nt
            end,
            __call = function(...) return create_dummy() end,
            __add = function() return create_dummy() end,
            __sub = function() return create_dummy() end,
            __mul = function() return create_dummy() end,
            __div = function() return create_dummy() end
        })
        return t
    end


    if mod == "neverlose/pui" or mod == "pui" then return create_dummy() end
...
utils = {
    get_vfunc = function(...) return function(...) return 0 end end,
    execute_after = function(...) end,
    trace_line = function(...) return {fraction=1, end_pos=vector()} end,
    trace_bullet = function(...) return 100, {entity=nil, hitgroup=1} end,
    net_channel = function() return {latency={0}} end,
    random_int = function() return 0 end,
}

ffi = {
    typeof = function(s) return function(...) return "ptr" end end,
    string = function(...) return "" end,
    cast = function(...) return {[0]={[6]={weight=0}}} end,
}

panorama = {
    GameStateAPI = { GetLocalPlayerXuid = function() return "123456" end },
    SteamOverlayAPI = { OpenExternalBrowserURL = function() end },
}

render = {
    screen_size = function(...) return vector() end,
    measure_text = function(...) return vector() end,
    load_font = function(...) return 1 end,
    text = function(...) end,
    blur = function(...) end,
    shadow = function(...) end,
    poly = function(...) end,
    line = function(...) end,
    rect = function(...) end,
    rect_outline = function(...) end,
    gradient = function(...) end,
    circle = function(...) end,
    circle_outline = function(...) end,
    circle_3d = function(...) end,
    circle_3d_outline = function(...) end,
    circle_3d_gradient = function(...) end,
    texture = function(...) end,
    push_clip_rect = function(...) end,
    load_image = function(...) return {width=0, height=0} end,
    load_image_rgba = function(...) return {width=0, height=0} end,
    camera_angles = function(...) return vector() end,
    push_alpha = function(...) end,
    pop_alpha = function(...) end,
    push_rotation = function(...) end,
    pop_rotation = function(...) end,
...
ui = {
    get_mouse_position = function(...) return vector() end,
    get_style = function(...) return {lerp=function() return color() end, to_hex=function() return "000000" end} end,
    get_icon = function(...) return "" end,
    localize = function(...) end,
    get_binds = function(...) return {} end,
}
...
setmetatable(db, {
    __index = function(self, k)
        local t = {version=1, configs={}, stats={}}
        rawset(self, k, t)
        return t
    end
})
...
entity = {
    get_local_player = function(...) return {
        ...
        get_player_info = function() return {userid=1} end,
        m_fFlags = 0,
        m_flDuckAmount = 0,
        m_vecVelocity = vector(),
        get_origin = function() return vector() end,
        get_eye_position = function() return vector() end,
        get_anim_state = function() return {landing=false} end,
        get_anim_overlay = function() return {} end,
        get_player_weapon = function() return {get_weapon_info=function() return {weapon_type=1, full_auto=false, time_to_idle=0, is_revolver=false, recovery_time_crouch=0, recovery_time_stand=0, damage=100, headshot_multiplier=4, armor_ratio=2} end, get_weapon_index=function() return 1 end, m_flNextPrimaryAttack=0, m_flNextSecondaryAttack=0, get_spread=function() return 0 end, get_inaccuracy=function() return 0 end, m_bPinPulled=false, m_fThrowTime=0, get_max_speed=function() return 250 end} end,
        m_nTickBase = 0,
        get_simulation_time = function() return {current=0} end,
        simulate_movement = function(...) return {think=function() end, origin=vector(), view_offset=0, flags=0} end,
        m_flNextAttack = 0,
        m_flVelocityModifier = 1,
        m_bIsScoped = false,
        m_MoveType = 0,
        m_flPoseParameter = {[0]=0,[6]=0,[7]=0,[12]=0},
    } end,
    get_players = function(...) return {} end,
    get_threat = function(...) return nil end,
    get_game_rules = function(...) return {} end,
    get_entities = function(...) end,
    get = function(...) return nil end,
}

cvar = setmetatable({}, {__index = function(self, k) return {int = function() return 0 end, string = function() return "name" end, float = function() return 0.0 end} end})

materials = {
    get_materials = function(...) end,
}
...
rage = {
    exploit = {
        ...
        force_teleport = function(...) end,
        allow_defensive = function(...) end,
    }
}
...
do
    ...
    for state_index = 1, #aa_states.states do
        ...
        do
            ...
            if not l_v772_0.o then l_v772_0.o = {lr=function() end, mid=function() end} end
...
link_aa_builder_to_config_or_features_module_or_aa_runtime_context.viewmodel = {
    ...
    run = function (viewmodel_module)
        ...
        for _, v1501 in next, {l_viewmodel_5.fov, l_viewmodel_5.x, l_viewmodel_5.y, l_viewmodel_5.z} do
